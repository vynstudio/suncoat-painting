        ...
        <div className="mt-8 flex flex-wrap gap-2">
          {siteConfig.cities.map((city) => (
            <Link
              ...
              className="rounded-full border border-slate-200 px-5 py-2 text-sm font-medium text-slate-700 transition hover:border-amber-300 hover:bg-amber-50"
            >
              {city.fullName}
            </Link>
          ))}
          <Link
            href="/contact"
            className="rounded-full border border-dashed border-slate-300 px-5 py-2 text-sm font-medium text-slate-500 transition hover:bg-slate-50"
          >
            + More cities
          </Link>
        </div>
