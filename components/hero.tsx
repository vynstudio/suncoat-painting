        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/40 px-6 py-3 text-base font-medium text-white backdrop-blur transition hover:bg-white/10"
            >
